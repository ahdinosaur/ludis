...
pub fn core_module(
    ...
    match core_module_id {
        ...
        Flatpak::ID => core_module_for_resource::<Flatpak>(params).map(ResourceParams::Flatpak),
        FlatpakRemote::ID => {
            core_module_for_resource::<FlatpakRemote>(params).map(ResourceParams::FlatpakRemote)
        }
